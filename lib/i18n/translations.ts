...
export const translations = {
  en: {
    ...
    // ── Habits ──
    'habits.title': 'Habits',
    'habits.subtitle': 'Self-care & routine tracking',
    'habits.days': 'S,M,T,W,T,F,S',
    'habits.empty': 'No habits tracked yet',
    'habits.emptyHint': 'Tap "Manage habits" below to pick what to track.',
    'habits.doneToday': '✓ Done',
    'habits.markDone': 'Mark done',
    'habits.goalMet': 'Goal met!',
    'habits.manage': 'Manage habits',
    'habits.catPersonal': 'Personal care',
    'habits.catClean': 'Order & cleanliness',
    'habits.catHealth': 'Health & habits',

    // ── Pet ──
    'pet.title': 'My Buddy',
    'pet.subtitle': 'Earn points, level up your companion',
    'pet.adoptTitle': 'Choose your companion',
    'pet.adoptSubtitle': 'Pick a starter, name it, make it yours',
    'pet.choosePet': 'Choose a character',
    'pet.chooseName': 'Pick a name',
    'pet.namePlaceholder': 'e.g. Buddy',
    'pet.choosePalette': 'Color palette',
    'pet.adopt': 'Adopt!',
    'pet.points': 'Points',
    'pet.streakWeeks': 'Week streak',
    'pet.weeklyReward': 'Weekly deficit reward',
    'pet.lastWeekSummary': 'Last week: {logged} days logged, {deficit} in deficit.',
    'pet.claimReward': 'Claim {points} points!',
    'pet.claimedMsg': '+{points} points! Streak: {streak} weeks 🔥',
    'pet.alreadyClaimed': 'Reward claimed for last week — keep the deficit going!',
    'pet.notEligible': 'Log at least 5 days with no surplus days (4+ in deficit) to earn the weekly reward.',
    'pet.accessories': 'Accessories',
    'pet.equip': 'Equip',
    'pet.unequip': 'Unequip',
    'pet.myPets': 'My collection',
    'pet.goToShop': 'Visit the reward shop',

    // ── Shop ──
    'shop.title': 'Reward Shop',
    'shop.subtitle': 'Spend points you earned',
    'shop.tabPets': 'Characters',
    'shop.tabAccessories': 'Accessories',
    'shop.tabThemes': 'App Design',
    'shop.owned': 'Owned',
    'shop.otherPet': 'different character',
    'shop.emptyTab': 'Nothing here yet — keep earning!',
  ...
  he: {
    ...
    // ── Habits ──
    'habits.title': 'הרגלים',
    'habits.subtitle': 'מעקב טיפוח עצמי ושגרה',
    'habits.days': 'א,ב,ג,ד,ה,ו,ש',
    'habits.empty': 'עדיין לא עוקבים אחרי הרגלים',
    'habits.emptyHint': 'לחץ על "ניהול הרגלים" למטה כדי לבחור מה לעקוב.',
    'habits.doneToday': '✓ בוצע',
    'habits.markDone': 'סמן כבוצע',
    'habits.goalMet': 'היעד הושג!',
    'habits.manage': 'ניהול הרגלים',
    'habits.catPersonal': 'טיפוח אישי',
    'habits.catClean': 'סדר וניקיון',
    'habits.catHealth': 'בריאות והרגלים',

    // ── Pet ──
    'pet.title': 'החבר שלי',
    'pet.subtitle': 'צבור נקודות ושדרג את החבר שלך',
    'pet.adoptTitle': 'בחר את החבר שלך',
    'pet.adoptSubtitle': 'בחר דמות, תן שם, ועשה אותה שלך',
    'pet.choosePet': 'בחר דמות',
    'pet.chooseName': 'בחר שם',
    'pet.namePlaceholder': 'למשל: באדי',
    'pet.choosePalette': 'פלטת צבעים',
    'pet.adopt': 'אמץ!',
    'pet.points': 'נקודות',
    'pet.streakWeeks': 'רצף שבועות',
    'pet.weeklyReward': 'פרס גירעון שבועי',
    'pet.lastWeekSummary': 'שבוע שעבר: {logged} ימים תועדו, {deficit} בגירעון.',
    'pet.claimReward': 'קבל {points} נקודות!',
    'pet.claimedMsg': '+{points} נקודות! רצף: {streak} שבועות 🔥',
    'pet.alreadyClaimed': 'הפרס נאסף עבור השבוע שעבר — המשך בגירעון!',
    'pet.notEligible': 'תעד לפחות 5 ימים ללא ימי עודף (4+ בגירעון) כדי לזכות בפרס השבועי.',
    'pet.accessories': 'אביזרים',
    'pet.equip': 'לבש',
    'pet.unequip': 'הסר',
    'pet.myPets': 'האוסף שלי',
    'pet.goToShop': 'בקר בחנות הפרסים',

    // ── Shop ──
    'shop.title': 'חנות הפרסים',
    'shop.subtitle': 'בזבז נקודות שהרווחת',
    'shop.tabPets': 'דמויות',
    'shop.tabAccessories': 'אביזרים',
    'shop.tabThemes': 'עיצוב האפליקציה',
    'shop.owned': 'בבעלותך',
    'shop.otherPet': 'דמות אחרת',
    'shop.emptyTab': 'אין כאן כלום עדיין — המשך להרוויח!',
